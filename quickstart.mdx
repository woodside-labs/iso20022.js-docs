...
Electrical is a company based in Spain that needs to send a SEPA payment to Kylian Mbappé, also in Spain. Electrical's bank, like most in Europe,
...
At the end of the tutorial, we'll demonstrate how to store and upload the payment message to the bank using [Fiat Web Services](/quickstart#step-4-save-the-payment-using-fiat-web-services-and-upload-to-bank).
...
In order to execute the ISO20022 message at the bank, the message needs to be saved and uploaded onto the bank. Typically this is done with a bank portal that is on file.

You can use Fiat Web Services to save, track, and send the XML file to your bank. Sign up for [Fiat Web Services here.](https://fiatwebservices.com)
