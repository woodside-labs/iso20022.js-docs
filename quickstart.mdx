...
Payments transmission is not supported by iso20022.js yet, but we can use off the shelf SFTP libraries to send the XML file to Electrical's banking partner in the format they expect.
...
await sftp.put(creditPaymentInitiation.toString(), '/ELECTRIC_20240804123456_001');
