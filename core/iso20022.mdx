...
Here's a short markdown description of the TypeScript class for a Mintlify page:
...
In this case, `ACMECORP` is a unique ID given by the bank to identify the initiating party.
