...
Learn how to communicate with banks using ISO20022 standards to move money or ingest financial data. Some examples of how companies may use `iso20022.js` include:

- Powering payments for a utility company in Spain
- Automating payments to content creators throughout Europe
- Running cash advance programs in the U.S.
